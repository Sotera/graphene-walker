...
public class TransactionDAOSQLImpl extends
		GenericDAOJDBCImpl<WalkerTransactionPair100, EventQuery> implements
		TransactionDAO<WalkerTransactionPair100, EventQuery> {
	 ...
	 * @throws Exception
	 */
	private SQLQuery buildQuery(EventQuery q, QWalkerTransactionPair100 t,
	...
	public List<DirectedEventRow> getEvents(EventQuery q) {
		...
		try {
			for (WalkerTransactionPair100 e : findByQuery(q)) {
