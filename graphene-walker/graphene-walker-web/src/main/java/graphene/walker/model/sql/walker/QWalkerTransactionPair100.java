...
public class QWalkerTransactionPair100 extends com.mysema.query.sql.RelationalPathBase<WalkerTransactionPair100> {
    ...
    private static final long serialVersionUID = -1564216630;
    ...
    public final StringPath trnSubjStr = createString("trnSubjStr");
    ...
    public void addMetadata() {
        ...
        addMetadata(trnSubjStr, ColumnMetadata.named("TRN_SUBJ_STR").ofType(12).withSize(1000));
        ...
        addMetadata(trnValueStr, ColumnMetadata.named("TRN_VALUE_STR").ofType(12).withSize(999999));
    }
