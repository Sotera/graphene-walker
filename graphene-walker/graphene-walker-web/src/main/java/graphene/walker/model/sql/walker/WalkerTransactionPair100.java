...
/**
 * WalkerTransactionPair100 is a Querydsl bean type
 */
@Generated("com.mysema.query.codegen.BeanSerializer")
public class WalkerTransactionPair100 implements Serializable {
    ...
    public String getTrnSubjStr() {
        return trnSubjStr;
    }

    public void setTrnSubjStr(String trnSubjStr) {
        this.trnSubjStr = trnSubjStr;
    }
    ...
    public String toString() {
         return "idSearchToken = " + idSearchToken + ", pairId = " + pairId + ", receiverId = " + receiverId + ", receiverValueStr = " + receiverValueStr + ", senderId = " + senderId + ", senderValueStr = " + senderValueStr + ", trnDt = " + trnDt + ", trnSubjStr = " + trnSubjStr + ", trnType = " + trnType + ", trnValueNbr = " + trnValueNbr + ", trnValueNbrUnit = " + trnValueNbrUnit + ", trnValueStr = " + trnValueStr;
    }
